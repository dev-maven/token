...
<html lang="en">
	<head>
		...
		<meta
			name="description"
			content="PetToken is the most prospective token in the market"
		/>
		<!-- SITE TITLE -->
		<title>PetToken - Most prospective token in the market</title>
		<!-- Favicon Icon -->
		<link
			rel="shortcut icon"
			type="image/x-icon"
	...
	<body class="v_dark" data-spy="scroll" data-offset="110">
				...
				<nav class="navbar navbar-expand-lg">
					...
					>
						...
						>
							...
							<li>
								<a class="nav-link page-scroll" href="#road_map">Road Map</a>
							</li>
						...
						<ul
							class="navbar-nav nav_btn animation"
							data-animation="fadeInRight"
							data-animation-delay="1.6s"
						>
							<li>
								<a class="btn btn-default" href="light-index.html"
									>Try Light Mode</a
								>
							</li>
						</ul>
				...
				<div class="row align-items-center">
					...
					>
						<div class="banner_text">
							...
							>
								Join the most prospective token available in the market. With
								the best guaranteed returns!
							</p>
							<div
							...
							>
								<a href="#" class="btn btn-border"
									>Buy on Pancakeswap <i class="ion-ios-arrow-thin-right"></i
								></a>
							</div>
						</div>
					</div>
					<div class="col-lg-6 col-md-12 col-sm-12 order-first">
						...
						>
							<img
								src="assets/images/banner_vector2.png"
								alt="banner_vector2"
							/>
						</div>
					</div>
		...
		<section
			id="how_it_work"
			class="how_work small_pt small_pb"
			data-parallax="scroll"
			data-image-src="assets/images/team_bg2.png"
		>
			<div class="container">
				<div class="row align-items-center">
				...
				<div class="row align-items-center">
					<div class="col-lg-6 col-md-6 col-sm-12">
						...
						<a
							...
							class="btn btn-default video animation"
							data-animation="fadeInUp"
							data-animation-delay="0.6s"
							><span class="ion-play"></span>Learn More
							<i class="ion-ios-arrow-thin-right"></i
						></a>
					</div>
					<div class="col-lg-6 col-md-6 col-sm-12">
						<div
							class="animation res_sm_mt_30"
							data-animation="fadeInRight"
							data-animation-delay="0.1s"
						>
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-7 col-md-12 col-sm-12 text_md_center">
						...
						<div class="row">
							<div class="col-md-6 col-sm-12">
								<div
									class="pr_box animation"
									data-animation="fadeInUp"
									data-animation-delay="0.1s"
								>
									<h6>Starting time :</h6>
									<p>August 2, 2021 (Monday 9:00 AM)</p>
								</div>
							</div>
							<div class="col-md-6 col-sm-12">
								<div
								...
								>
									<h6>Ending time :</h6>
									<p>December 31st, 2021 (Friday 11:00 PM)</p>
								</div>
							</div>
							<div class="col-md-6 col-sm-12">
								<div
							...
							<div class="col-md-6 col-sm-12">
								...
								>
									...
									<p>All Coins and Valued Token</p>
								</div>
							</div>
						</div>
					</div>
					...
					>
						...
						<div
							class="tk_countdown text-center animation countdown_shape"
							data-animation="fadeInUp"
							data-animation-delay="0.1s"
						>
							<div class="tk_counter_inner">
								<div
									class="tk_countdown_time"
									data-time="2021/12/31 23:00:00"
								></div>
				...
				<div class="row align-items-center res_md_mt_20">
					<div class="col-md-7">
						<div
							class="token_chart res_sm_mb_30 text-center animation"
							data-animation="fadeInLeft"
							data-animation-delay="0.2s"
						>
							<canvas id="token_sale"></canvas>
							<div class="pie_chart_icon">
								<img src="assets/images/pie_chart_icon.png" />
							</div>
						</div>
					</div>
					<div class="col-md-5">
		...
		<section id="road_map" class="small_pt small_pb">
			<div class="container">
				...
				<div
					class="roadmap owl-carousel small_space animation"
					data-animation="fadeInUp"
					data-animation-delay="0.4s"
				>
					<div class="item">
						<div class="roadmap_box rd_complete">
							<div class="roadmap_inner">
								...
								<h6>December 2021</h6>
								<p>Initial Coin Distribution &amp; marketing</p>
							</div>
						</div>
					</div>
					<div class="item">
					...
					<div class="item">
						<div class="roadmap_box">
							<div class="roadmap_inner">
								<div class="roadmap_icon icon_gradient_box"></div>
								<h6>March 2022</h6>
								<p>Send-Receive coin token &amp; mobile</p>
							</div>
						</div>
					</div>
					<div class="item">
					...
					<div class="item">
						<div class="roadmap_box">
							<div class="roadmap_inner">
								<div class="roadmap_icon icon_gradient_box"></div>
								<h6>December 2022</h6>
								<p>Deposit Token from your account</p>
							</div>
						</div>
					</div>
					<div class="item">
				...
				<div id="mobileapp" class="mobileapp text_md_center">
					...
					<div class="row align-items-center">
						<div class="col-lg-6 col-md-12 col-sm-12">
							...
							>
								<a href="#" class="btn btn-default"
									><span class="ion-ios-cart"></span>Buy now
									<i class="ion-ios-arrow-thin-right"></i
								></a>
							</div>
						</div>
						<div class="col-lg-6 col-md-12 col-sm-12 text-center">
							<div
								class="res_md_mt_50 res_sm_mt_30 animation"
								data-animation="fadeInRight"
								data-animation-delay="0.1s"
							>
								<img src="assets/images/mobile_dark.png" alt="mobile" />
							</div>
						</div>
					</div>
				</div>
		...
		<section
			id="team"
			class="team_wrap small_pt small_pb"
			data-parallax="scroll"
			data-image-src="assets/images/team_bg2.png"
		>
			<div class="container">
						...
						<div class="col-lg-8 col-md-12 offset-lg-2">
							<div id="accordion" class="faq_content">
								...
								>
									...
									>
										<div class="card-body">
											Cryptocurrency is a form of payment that can be exchanged
											online for goods and services. Many companies have issued
											their own currencies, often called tokens, and these can
											be traded specifically for the good or service that the
											company provides. Think of them as you would arcade tokens
											or casino chips. You'll need to exchange real currency for
											the cryptocurrency to access the good or service.
										</div>
									</div>
								</div>
								<div
									...
									<div class="card-header" id="headingTwo">
										<h6 class="mb-0">
											<a
												...
												>Which cryptocurrency is best to buy today?</a
											>
										</h6>
									</div>
									<div
									...
									<div class="card-header" id="headingThree">
										<h6 class="mb-0">
											<a
												...
												>How about day trading crypto?</a
											>
										</h6>
									</div>
									<div
									...
									<div class="card-header" id="headingFour">
										<h6 class="mb-0">
											<a
												...
												>When to sell a cryptocurrency?</a
											>
										</h6>
									</div>
									<div
					...
					<div class="col-lg-7 col-md-7">
						<div class="title_light">
							...
							<p
								...
								data-animation-delay="0.3s"
							>
								Marketers create whitepapers to educate their audience about a
								particular issue, or explain and promote a particular
								methodology.
							</p>
						</div>
						<a
							class="btn btn-default animation"
							data-animation="fadeInUp"
							data-animation-delay="0.4s"
							href="#"
							><span class="ion-ios-open"></span>Open Now
							<i class="ion-ios-arrow-thin-right"></i
						></a>
					</div>
					<div class="col-lg-4 offset-lg-1 col-md-5">
						<div
							class="res_md_mt_30 animation"
							data-animation="fadeInRight"
							data-animation-delay="0.1s"
						>
			...
			<div class="container">
				...
				<div class="row align-items-center text_md_center">
					<div class="col-lg-2 col-md-4 col-6">
						...
						>
							<img
								src="assets/images/light_client_logo1.png"
								alt="client_logo1"
							/>
						</div>
					</div>
					<div class="col-lg-2 col-md-4 col-6">
						...
						>
							<img
								src="assets/images/light_client_logo2.png"
								alt="client_logo2"
							/>
						</div>
					</div>
					<div class="col-lg-2 col-md-4 col-6">
						...
						>
							<img
								src="assets/images/light_client_logo3.png"
								alt="client_logo3"
							/>
						</div>
					</div>
					<div class="col-lg-2 col-md-4 col-6">
						...
						>
							<img
								src="assets/images/light_client_logo4.png"
								alt="client_logo4"
							/>
						</div>
					</div>
					<div class="col-lg-2 col-md-4 col-6">
						...
						>
							<img
								src="assets/images/light_client_logo5.png"
								alt="client_logo5"
							/>
						</div>
					</div>
					<div class="col-lg-2 col-md-4 col-6">
						...
						>
							<img
								src="assets/images/light_client_logo6.png"
								alt="client_logo6"
							/>
						</div>
					</div>
			...
			<div class="bottom_footer staggered-animation-wrap">
				<div class="container">
					<div class="row">
						<div class="col-sm-12">
							<p
								class="copyright staggered-animation text-center"
								data-animation="fadeInLeft"
								data-animation-delay="0.1s"
							>
								Copyright ©
		...
		<a
			href="#"
			class="scrollup btn-default animation"
